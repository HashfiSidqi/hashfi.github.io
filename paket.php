			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-12">
						...
						<div class="heading">
							<h2 class="title">Daftar Harga & Paket Pernikahan </h2>
						...
						<div class="image-gallery">
							...
							<div class="row">
								<?php
								$galeri = mysqli_query($conn, "SELECT * FROM paket_pernikahan");
								while ($infoGaleri = mysqli_fetch_array($galeri)) {
								?>
									<tr>
										<td>
											<?php
											$judul = $infoGaleri['NamaPaket'];
											// if (empty($judul)) {
										...
										<td>
											<div>
												<a href="Admin/fileUpload/<?php echo $infoGaleri['NamaFile']; ?>" data-fluidbox><img class="margin-bottom" src="Admin/fileUpload/<?php echo $infoGaleri['NamaFile']; ?>" style="height:200"></a>
